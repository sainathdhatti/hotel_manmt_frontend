...
import useBookingsStore, { Booking, BookingStatus } from "@/app/store/bookingStore";
                        ...
                        <td className="px-4 py-2 text-center text-pink-500">
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              if (booking.status !== BookingStatus.CHECKED_OUT && booking.status !== BookingStatus.CANCELLED) {
                                handleStatusChange(booking.bookingId, newStatus);
                              }
                            }}
                            className={`border border-gray-300 rounded-md p-1 ${
                              booking.status === BookingStatus.CHECKED_OUT ? "bg-gray-200 cursor-not-allowed" : ""
                            }`}
                            disabled={booking.status === BookingStatus.CHECKED_OUT || booking.status === BookingStatus.CANCELLED}
                          >
