...
const schema = yup.object().shape({
  ...
  noOfChildrens: yup.number().required("Number of children is required"),
});
...
const BookingForm = () => {
  ...
  const fetchRoomCategory = useRoomCategoryStore(
    (state) => state.getRoomCategory
  );
    ...
    <div className="p-6 flex">
      ...
      {/* <div className="absolute inset-0">
          <img
            ...
            className="bg-opacity-100 w-full h-full object-cover"
          />
        </div> */}
        ...
        {roomCategory ? (
          <>
            <img
              ...
              className="w-full h-80 object-cover ml-5"
            />
      ...
      <div className="w-2/3 ml-10 mt-10">
        ...
        <div className="flex mt-7 ml-10">
          <div className="flex-1 mr-2">
            ...
            >
              ...
              {roomCategory && roomCategory.noOfAdults ? (
                Array.from(
                  { length: roomCategory.noOfAdults },
                  (_, i) => i + 1
                ).map((option) => (
          ...
          <div className="flex-1 ml-0 mr-32">
            ...
            >
              ...
              {roomCategory && roomCategory.noOfChildren ? (
                Array.from(
                  { length: roomCategory.noOfChildren },
                  (_, i) => i + 1
                ).map((option) => (
                  <option key={option} value={option}>
                    {option}
